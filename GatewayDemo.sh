...
while true; do
    ...
    case $choice in
        ...
        k|K)
            ...
            ;;
        m|M)
            echo "Verifying all deployed resources..."
            echo "=========================================="
            echo "Deployments:"
            kubectl get deployments -n default -o wide | grep avi-hello-world || echo "No deployments found"
            echo ""
            echo "Services:"
            kubectl get services -n default -o wide | grep -E "avi-service|svc-v" || echo "No services found"
            echo ""
            echo "Gateways:"
            kubectl get gateways -n default -o wide || echo "No gateways found"
            echo ""
            echo "HTTPRoutes:"
            kubectl get httproutes -n default -o wide || echo "No HTTPRoutes found"
            echo ""
            echo "HealthMonitors:"
            kubectl get healthmonitors -n default -o wide || echo "No HealthMonitors found"
            echo ""
            echo "L7Rules:"
            kubectl get l7rules -n default -o wide || echo "No L7Rules found"
            echo ""
            echo "RouteBackendExtensions:"
            kubectl get routebackendextensions -n default -o wide || echo "No RouteBackendExtensions found"
            echo ""
            echo "AVIInfrasettings:"
            kubectl get aviinfrasettings -n default -o wide || echo "No AVIInfrasettings found"
            echo "=========================================="
            echo -n "Press any key to continue..."
            read -n 1 -s
            ;;
